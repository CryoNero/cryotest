...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "CRNO";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "CRNO";
    ...
    const std::string daemonName = "CryoNerod";

    /* The name to call this wallet */
    const std::string walletName = "cryowallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "cryonero-service";
